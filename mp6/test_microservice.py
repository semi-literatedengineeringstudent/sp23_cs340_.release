...
def test_cache_is_empty(start_microservice, test_client):
...
def test_valid_course_with_space_lower(start_microservice,test_client):
    check_course(test_client,("cs 340","CS 340"))
    check_course(test_client,("cs 101","CS 101"))
...
def test_valid_course_without_space_upper(start_microservice,test_client):
    check_course(test_client,("CS450","CS 450"))
    check_course(test_client,("CS101","CS 101"))
...
def test_unavailable(start_microservice,test_client):
    check_course(test_client,("TEST 999","forecast unavailable"))

def test_valid_course_case_insensitive(start_microservice,test_client):
    check_course(test_client,("cS374","CS 374"))
    check_course(test_client,("Cs101","CS 101"))

def test_blank_course(start_microservice,test_client):
    check_course(test_client,(" ",False))
    check_course(test_client,("   ",False))
    check_course(test_client,("",False))
